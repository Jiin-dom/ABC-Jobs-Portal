        ...
        <div class="container navcont">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a href="<%= request.getContextPath() %>/homepage" class="nav-link nav-link-header2" style="color:#2D77CE">
                            <i class="bi bi-house-door-fill bi-header2"></i>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="<%= request.getContextPath() %>/jobs" class="nav-link nav-link-header2" style="color:#2D77CE">
                    ...
                    <li class="nav-item">
                        <a href="<%= request.getContextPath() %>/applied-jobs" class="nav-link nav-link-header2" style="color:#2D77CE">
